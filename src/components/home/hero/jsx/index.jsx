...
import ButtonRoundedFull from "@/atoms/atoms-shiva/button/rounded-full/jsx"
...
const HeroSection = () => {
    ...
    // AUTO CHANGE CURRENT SLIDES WITH TIME DELAY
    useEffect(() => {
    ...
    // FORMAT DATA FOR HEADING TEXT TO ADD COLORED TEXT
        ...
        >
            {
                ...
                slides.map( ( slide, index ) => (
                    ...
                    currentSlide === index && (
                        ...
                        <div className="absolute inset-0 mt-6 md:mt-0 grid md:grid-cols-2 gap-6" key={ index }>
            ...
            <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                <ButtonRoundedFull click_event={ handlePrevSlide }><IoIosArrowBack/></ButtonRoundedFull>
            </div>
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                <ButtonRoundedFull click_event={ handleNextSlide }><IoIosArrowForward/></ButtonRoundedFull>
            </div>
        </div>
